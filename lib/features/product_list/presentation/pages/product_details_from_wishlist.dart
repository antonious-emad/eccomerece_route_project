...
class ProductDetailsScreenFromWishList extends StatefulWidget {

  ProductDetailsScreenFromWishList({super.key});
  @override
  State<ProductDetailsScreenFromWishList> createState() => _ProductDetailsScreenState();
}
List<Color> clrs = [
...
bool fav=false;
class _ProductDetailsScreenState extends State<ProductDetailsScreenFromWishList> {
